<script lang="ts">
  ...
  async function loadNotes() {
    ...
    try {
      ...
      console.log('[loadNotes] Welcome note check: allNotes=%d, totalCount=%d, welcomeNoteCreated=%s, syncEnabled=%s, skipWelcome=%s',
        allNotes.length, totalCount, $settings.welcomeNoteCreated, $settings.syncEnabled, skipWelcome);
