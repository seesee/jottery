    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
      ...
      <div class="border-t border-gray-200 dark:border-gray-700 p-4 flex justify-end gap-3">
        ...
        <button
          ...
          disabled={!canConfirm}
          class="{confirmClass.replace('hover:', 'active:')} px-4 py-2.5 min-h-11 text-white font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {confirmText}
        </button>
      </div>
